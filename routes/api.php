...
Route::put('admin_commercial/{id}','AdminComercial@update_admin_commercials');
//url AdminLivraison
...
Route::put('admin_livraison/{id}','AdminLivraison@update_admin_livraisons');
//url SuperAdmin
Route::get('super_admin','SuperAdmin@get_super_admins');
Route::get('super_admin/{id}','SuperAdmin@get_super_admins_byid');
Route::put('super_admin/{id}','SuperAdmin@update_super_admins');
