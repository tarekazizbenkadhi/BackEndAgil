...
class rendez_vous_vbController extends Controller
{
    public function get_rv_cmd_bv_by_id($id)
    {
        $rv = DB::table('rendez_vous_bvs as rv')
    ...
    public function update_rv_cmd_bv(Request $request, $id)
    {

        $oc = DB::table('rendez_vous_bvs as rv')
